    ...
    <div className="flex flex-col items-center gap-6 px-5 pt-4">
        ...
        >
          ...
          <div className="backface-hidden absolute inset-0 bg-white rounded-3xl shadow-xl border border-gray-100 flex flex-col items-center justify-center gap-3 p-6">
            ...
            <button
              ...
              className="flex items-center gap-2 text-brand-orange bg-blue-50 px-4 py-2 rounded-xl text-sm font-semibold"
            >
              <Volume2 size={16} />
              Nghe phát âm
            </button>
          ...
          {/* Back */}
          <div className="backface-hidden rotate-y-180 absolute inset-0 bg-brand-orange rounded-3xl shadow-xl flex flex-col items-center justify-center gap-2 p-6">
            ...
            {item.example && (
              <div className="bg-brand-orange-dark rounded-2xl px-4 py-2 mt-2 text-center">
      ...
      <div className="w-full flex flex-col gap-3">
        <button
          ...
          className="w-full bg-brand-orange text-white font-bold py-4 rounded-2xl text-lg shadow-lg shadow-orange-200 active:scale-95 transition-transform"
        >
          Tôi đã biết ✓
        </button>
        <button
