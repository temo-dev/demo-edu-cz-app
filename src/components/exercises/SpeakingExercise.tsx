...
const PHONEME_TIPS: Array<{ chars: string[]; tip: string }> = [
  ...
  {
    chars: ["á", "é", "í", "ó", "ú", "ý", "ů"],
    tip: "Chữ có dấu = nguyên âm dài, kéo dài gấp đôi",
  },
    ...
    <div className="flex flex-col gap-5 px-5 pt-4">
      ...
      {status !== "unsupported" && (
        <div className="flex flex-col items-center gap-4">
          ...
          >
            {status === "idle" &&
              (attempts > 0 ? "🔄 Thử lại" : "🎙️ Nhấn mic để nói")}
          ...
          >
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-2xl p-4">
                ...
                <div className="flex flex-wrap gap-2">
                  {answer.split(" ").map((word, i) => (
                    <div
                      key={i}
                      className="bg-white rounded-xl px-3 py-2 border border-blue-200 text-center"
                    >
            ...
            <div className="flex gap-3">
              <button
                ...
                className="flex-1 flex items-center justify-center gap-2 bg-brand-orange text-white font-bold py-4 rounded-2xl text-base shadow-lg shadow-orange-200"
              >
      ...
      {status === "unsupported" && (
        <div className="flex flex-col gap-4">
          <div className="bg-yellow-50 border-2 border-yellow-200 rounded-2xl p-5 text-center">
            <p className="text-yellow-700 font-bold mb-1">
              ⚠️ Cần Chrome hoặc Edge
            </p>
          ...
          <button
            ...
            className="w-full bg-gray-200 text-gray-700 font-bold py-4 rounded-2xl text-lg"
          >
            Bỏ qua →
          </button>
        </div>
