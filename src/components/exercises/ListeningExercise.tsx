    ...
    <div className="flex flex-col gap-6 px-5 pt-4">
      ...
      <div className="flex flex-col items-center gap-3">
        ...
        <motion.button
          whileTap={{ scale: 0.9 }}
          onClick={playAudio}
          className="w-24 h-24 rounded-full bg-brand-orange shadow-xl shadow-orange-200 flex items-center justify-center"
        >
          <Volume2 size={40} className="text-white" />
        </motion.button>
        {!played && <p className="text-xs text-gray-400">Nhấn để nghe</p>}
        {selected && item && (
