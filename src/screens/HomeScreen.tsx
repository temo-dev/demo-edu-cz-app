  ...
  return (
    <div className="bg-babbel-bg min-h-full">
      ...
      <div className="bg-white px-5 pt-12 pb-4 flex items-center justify-between">
        <div>
          <p className="text-babbel-muted text-xs font-medium">
            Chào mừng trở lại,
          </p>
        ...
        <div className="flex items-center gap-3">
          <div className="flex items-center gap-1.5 bg-orange-50 px-3 py-1.5 rounded-full">
            ...
            <span className="text-babbel-orange font-bold text-sm">
              {streak}
            </span>
          </div>
          <button
      ...
      <div className="bg-white px-5 pb-4 border-b border-babbel-border">
        <div className="flex justify-between items-center mb-1.5">
          <p className="text-xs font-semibold text-babbel-muted">
            Mục tiêu hôm nay
          </p>
          <p className="text-xs font-bold text-babbel-text">
            ...
            return (
              ...
              >
                ...
                >
                  {/* Lesson label */}
                  <p
                    className={`text-xs font-bold uppercase tracking-widest ${color.sub} mb-2`}
                  >
                  ...
                  {/* Title */}
                  <h2
                    className={`text-xl font-extrabold leading-tight ${color.text} flex-1`}
                  >
                    {lesson.title}
                  </h2>
                  {lesson.subtitle && (
                    <p className={`text-sm mt-1 ${color.sub}`}>
                      {lesson.subtitle}
                    </p>
                  )}
                  ...
                  <div className="flex items-end justify-between mt-4">
                    <div className="flex items-center gap-1.5">
                      ...
                      {!done && unlocked && (
                        <span
                          className={`text-xs font-bold ${color.sub} bg-white/60 px-2 py-0.5 rounded-full`}
                        >
                          +{lesson.xpReward} XP
                        </span>
                      )}
        ...
        <div className="flex flex-col gap-3">
          ...
          >
            <div className="flex-1 text-left">
              ...
              <p className="text-babbel-text font-extrabold text-base">
                Xem thống kê
              </p>
            </div>
        ...
        <div className="grid grid-cols-2 gap-3">
          {course.units.map((unit) => (
            ...
            >
              ...
              <p className="text-babbel-text font-bold text-sm leading-tight">
                {unit.title}
              </p>
              <p className="text-babbel-muted text-xs mt-0.5">
                {unit.subtitle}
              </p>
            </button>
          ))}
